...
handles.guidata.hflies_apt = zeros(handles.data.nTargetsInCurrentExp,nPreviewAxes,2);
% fly path
    ...
    handles.guidata.hfly_markers(fly,i) = ...
      line('parent',handles.guidata.axes_previews(i), ...
           ...
           'ButtonDownFcn', ...
             @(hObject,eventdata) JLabel('fly_ButtonDownFcn',hObject,eventdata,guidata(hObject),fly,i),...
           'Visible','off');
    handles.guidata.hflies_apt(fly,i,1) = ...
      line('parent',handles.guidata.axes_previews(i), ...
           'xdata',nan, ...
           'ydata',nan, ...
           'marker','.', ...
           ...
           'ButtonDownFcn', ...
             @(hObject,eventdata) JLabel('fly_ButtonDownFcn',hObject,eventdata,guidata(hObject),fly,i),...
           'Visible','off');
    handles.guidata.hflies_apt(fly,i,2) = ...
      line('parent',handles.guidata.axes_previews(i), ...
           'xdata',nan, ...
           'ydata',nan, ...
           'marker','.', ...
  ...
  if refreshflies,    
    ...
    for fly = iFlyInbounds
      ...
      UpdateTargetPosition(handles.data.targettype,handles.guidata.hflies(j,i),...
        ...
        handles.guidata.hflies_apt(j,i,:),handles.guidata.data.aptInfo);
...
if verLessThan('matlab','8.4.0'),
  handles.guidata.hflies_apt = nan(maxnflies_curr,nPreviewAxes,2);
else
  handles.guidata.hflies_apt = gobjects(maxnflies_curr,nPreviewAxes,2);
end
...
handles = guidata(figureJLabel);
hobj = HandleObj;
ProjectSetup_App('figureJLabel',handles.figure_JLabel,...
