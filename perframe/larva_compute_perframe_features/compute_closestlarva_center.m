...
function [data,units,mind] = compute_closestlarva_center(trx,n,dosave_d)
...
for i1 = 1:nlarvae,
  larva1 = larvae(i1);
  larvae2 = larvae;
  dcenter = inf(numel(larvae2),trx(larva1).nframes);
  for i2 = 1:numel(larvae2),
    larva2 = larvae2(i2);
    if larva1 == larva2,
      continue;
    end
    dcenter(i2,:) = dcenter_pair(trx,larva1,larva2);
  end
