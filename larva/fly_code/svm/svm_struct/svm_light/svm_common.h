...
# define K_LINEAR  0           /* linear kernel type */
# define K_POLY    1           /* polynomial kernel type */
# define K_RBF     2           /* rbf kernel type */
# define K_SIGMOID 3           /* sigmoid kernel type */
# define K_CUSTOM  4           /* userdefined kernel function from kernel.h */
# define K_GRAM    5           /* use explicit gram matrix from kernel_parm */
...
typedef struct svector {
  SWORD    *words;              /* The features/values in the vector by
...
SVECTOR *create_svector(SWORD *, const char *, double);
SVECTOR *create_svector_shallow(SWORD *, char *, double);
SVECTOR *create_svector_n(double *, long, const char *, double);
SVECTOR *create_svector_n_r(double *, long, const char *, double, double);
...
int    parse_document(char *, SWORD *, double *, long *, long *, double *, long *, long, char **);
