...
public:
  TimelineWindow(wxWindow *w,  BehaviorTimelineControls *pa, wxSize sz=wxDefaultSize, long style=wxBORDER_SUNKEN);
...
public:
 GraphWindow(wxWindow *w,  GraphControls *pa, wxSize sz=wxDefaultSize, long style=wxBORDER_SUNKEN) :
  TimelineWindow(w, (BehaviorTimelineControls*)pa, sz, style) { 
    feat_ind = -1; 
    controls = pa; 
  }
...
class BehaviorTimelineControls {
 ...
 public:
  ...
  BehaviorTimelineControls(LabelFrame *parent, wxWindow *panel, int group_ind, wxSizer *sizer, int ind);
  BehaviorTimelineControls() { group_ind = -1; m_menu = NULL; m_add_button = m_edit_button = NULL; m_timeline = NULL; selected_behavior = -1; mode = MODE_NONE; }
