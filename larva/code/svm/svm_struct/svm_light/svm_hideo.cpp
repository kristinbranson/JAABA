...
//long   *lin_dependent;
//double *buffer;
//double *progress;    /* delta in the objective function between before and after */
{
...
int solve_dual(long n,long m,double precision,double epsilon_crit,long maxiter,double *g,double *g0,double *ce,
	       double *ce0,double *low,double *up,double *primal,
